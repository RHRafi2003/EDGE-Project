...
The Kali is the attacker machine and the **target** is Metasploitable 2 as web server and at last Windows 10 as employee machine, an intentionally vulnerable Linux machine used exclusively for educational and assessment purposes in a fully air-gapped VMware environment.
